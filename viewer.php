...
<body>
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <img src="assets/images/Seal_of_the_Philippines.png" alt="Seal of the Philippines" style="height: 100px;">
            <h1 class="text-center">LEGISLATIVE ORDINANCE OF TACLOBAN CITY</h1>
            <img src="assets/images/cropped-Tacloban_City_Seal.png" alt="Tacloban City Seal" style="height: 100px;">
        </div>

        <h3 class="text-center mb-4">Approved Ordinance Proposals</h3>
